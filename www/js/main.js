...
var BB = {
    ...
    setMap: function() {
        var blockMap = [
            [null,      'red',       'red',       'red',       'red',       'red',     'red',       'red',       'red',       'red'],
            [null,      'red',       null,       null,       null,      'blue',      null,     null,       null,       'silver'],
            [null,      'red',       null,       null,      'blue',      null,       'blue',       null,     null,       'silver'],
            [null,      'red',       null,      'blue',      null,       null,       null,       'blue',       null,     'silver'],    
            [null,      'red',      'blue',      null,       null,       'gold',     null,       null,       'blue',   'silver'],    
            [null,      'red',       null,      'blue',       null,       null,       null,       'blue',   null,   'silver'],    
            [null,      'red',       null,       null,      'blue',       null,       'blue',   null,   null,       'silver'],    
            [null,      'red',       null,       null,       null,   'blue',   null,   null,       null,       'silver'],
    ...
    reset: function() {
        ...
        var resetLabel = new PIXI.Text("RESET", {font: "30px/1.2 vt", fill: "yellow"});
        ...
        var label = new PIXI.Text("SCORE:", {font: "26px/1.2 vt", fill: "pink"});
        label.position.x = 20;
        label.position.y = 20;
        ...
        BB.scoreLabel = new PIXI.Text("0", {font: "28px/1.2 vt", fill: "red"});
